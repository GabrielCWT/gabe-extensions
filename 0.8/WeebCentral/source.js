...
class WeebCentral {
    constructor(cheerio) {
        ...
        this.RETRY = 5;
        this.parser = new WeebCentralParser_1.Parser();
    }
...
},{"./WeebCentralParser":71,"@paperback/types":61}],71:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Parser {
    ...
    parseHomeSections($, sectionCallback) {
        ...
        for (const recentObj of $('article', 'section.cols-span-1.rounded').toArray()) {
